/*:
 * @target MZ
 * @plugindesc Quest System (Dynamic categories, English UI, popups, no _cte)
 * @author aura-dev (modified by ChatGPT)
 * @help QuestsMz.js
 * 
 *
 * Data format for Quests.json:
 *{
 *  "Tutorial1": {
 *    "title": "Welcome to the Tutorial",
 *    "category": "Tutorial",
 *    "description": "A tutorial for QuestsMz.",
 *    "requirements": "None.",
 *    "rewards": "Patience.",
 *    "objectives": {
 *      "objectives1": "Next, adding a new objective to this quest!",
 *      "objectives2": "See how to override description, requirment and rewards."
 *    }
 *  }
 *}
 *
